...
export default new Vuex.Store({
  state: {
    ...
    citedDocuments: [
      ...
      /*ID 4*/"https://oa.upm.es/cgi/export/eprint/71455/BibTeX/upm-eprint-71455.bib",
      /*ID 5*/"https://oa.upm.es/cgi/export/eprint/71427/BibTeX/upm-eprint-71427.bib",
      /*ID 6*/"10.5281/zenodo.7185254",
      /*ID 7*/"10.5281/zenodo.7180961",
      /*ID 8*/"https://oa.upm.es/cgi/export/eprint/70949/BibTeX/upm-eprint-70949.bib",
      /*ID 9*/"https://oa.upm.es/cgi/export/eprint/67901/BibTeX/upm-eprint-67901.bib",
      /*ID 10: Cannot be cited, no content*/
      /*ID 11: Cannot be cited, no content*/
      /*ID 12*/"10.1007/978-3-031-17105-5_11",
    ],
  },
  getters: {
  },
